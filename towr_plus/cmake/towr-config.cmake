...
#   towr_plus::towr  - variables and constraints for legged locomotion
#
#
# Example usage
# ^^^^^^^^^^^^^
...
#   target_link_libraries(foo PUBLIC towr_plus::towr)
#
#
# Result variables
# ^^^^^^^^^^^^^^^^
...
get_target_property(towr_INCLUDE_DIRS towr_plus::towr INTERFACE_INCLUDE_DIRECTORIES)
list(APPEND towr_INCLUDE_DIRS ${ifopt_INCLUDE_DIRS})

get_property(towr_LIBRARIES TARGET towr_plus::towr PROPERTY LOCATION)
